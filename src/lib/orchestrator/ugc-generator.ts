import { processProductUrl } from '@/lib/intelligence/pipeline';
import { resolveAssets } from '@/lib/assets/asset-resolver';
import { buildVideoCompositionProps } from '@/lib/assets/composition-props-builder';
import { renderUgcVideo } from '@/lib/renderer/render-ugc-video';
